  ...
  Future<List<Map<String, dynamic>>> generateBatchReelContent({
    ...
    try {
      ...
      if (template != null) {
         ...
         IMPORTANT OVERRIDES:
         1. LANGUAGE: Write 'text' fields STRICTLY in $language.
...
1. LANGUAGE: Write 'text' STRICTLY in $language.
2. STYLE: Simple, direct, fairytale-like. Short sentences. (e.g. "One day a boy found a tiger. He fed it.")
3. TEXT CONTENT: Spoken words only. NO labels.
